...
async function main() {
    ...
    const btcNft = new ethers.Contract("0x4873960a8B6d3F2EeaF9d16931d2eB5763Ada1f2", abi, signer)
    ...
    tx = await btcNft.grantRole(RoleInBytes2, '0xbf7184178d610d7b0239a5cb8d64c1df22d306a9')
    console.log(tx);
}
